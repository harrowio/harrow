(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.Lom = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
'use strict';
...
var Brush = exports.Brush = function () {
  ...
  // apply the Brush' attributes to a target element
  ...
  _createClass(Brush, [{
    ...
    value: function apply(target) {
      ...
      target.classList.add('lom-fg-' + this.fg);
      target.classList.add('lom-bg-' + this.bg);
    }
  }, {
    key: 'equals',
    value: function equals(other) {
      ...
      return other.fg == this.fg && other.bg == this.bg;
    }
  }, {
    key: 'clone',
...
},{"../lib/utils":11}],2:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
var cursorHandler = exports.cursorHandler = function cursorHandler(lom, ev) {
  if (ev.type != 'cursor') {
    return false;
  }
  ...
  switch (ev.action) {
    case 'backward':
      ...
      break;
    case 'horizontal-tab':
      var target = lom.distanceToNextTabStop();
    ...
    case 'line-feed':
      lom.pushLine();
      // update the start-of-line brush
      lom.startBrush = lom.currentBrush.clone();
      lom.currentLine = [];
      lom.cursor = 0;
      break;
  }
...
exports.displayHandler = undefined;

var _brush = require('../brush');

var displayHandler = exports.displayHandler = function displayHandler(lom, ev) {
  if (ev.type != 'display') {
    return false;
  }
  ...
  switch (ev.attr) {
    case 'bright':
      lom.currentBrush.bright = true;
      break;
    case 'dim':
      lom.currentBrush.dim = true;
      break;
    case 'reset':
      lom.currentBrush = new _brush.Brush();
      break;
  }

  if (ev.fg && ev.fg != 0) {
    lom.currentBrush.fg = ev.fg - 1;
  }
  if (ev.bg && ev.bg != 0) {
    lom.currentBrush.bg = ev.bg - 1;
  }

  return true;
};

},{"../brush":1}],4:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
var eofHandler = exports.eofHandler = function eofHandler(lom, ev) {
...
var foldHandler = exports.foldHandler = function foldHandler(lom, ev) {
  if (ev.type != 'fold') {
    return false;
  }
  ...
  switch (ev.action) {
    case 'open':
      lom.openFold(ev.title);
      break;
    case 'close':
      lom.closeFold();
      break;
    default:
      console.log('fold: unknown action', ev.action);
  }
...
var textHandler = exports.textHandler = function textHandler(lom, ev) {
  if (ev.type != 'text') {
    return false;
  }
  ...
  try {
    for (var _iterator = ev.raw[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var ch = _step.value;
...
var LogLine = exports.LogLine = function () {
  function LogLine(lineNumber, content) {
  ...
  _createClass(LogLine, [{
    key: "render",
    value: function render(lineView) {
      lineView.showLineNumber(this.lineNumber);
      lineView.showLineContent(this.content);
      lineView.flush();
    }
  }]);
...
exports.LogView = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _table_row_line_view = require('./table_row_line_view');
...
var LogView = exports.LogView = function () {
  function LogView(container) {
    _classCallCheck(this, LogView);

    this.container = container;
    this.counter = 0;
    this.highlightedLines = this._getHighlightedLines();
    this.currentFold = null;
  }

  _createClass(LogView, [{
    key: '_getHighlightedLines',
    value: function _getHighlightedLines() {
      var match = location.hash.match(/#L(\d+)(?:\-L(\d+))?$/);
    ...
    key: 'endFold',
    value: function endFold() {
      if (this.currentFold && this.highlightedLines && !this.currentFold.classList.contains('open') && this.counter >= this.highlightedLines.rangeStart && this.counter <= this.highlightedLines.rangeEnd) {} else if (this.currentFold && this.currentFold.classList.contains('open')) {
        this.currentFold.classList.remove('open');
      }
      this.currentFold = null;
    }
  }, {
    key: 'beginFold',
    value: function beginFold(name) {
      this.currentFold = document.createElement('div');
      this.container.appendChild(this.currentFold);
      this.currentFold.classList.add('lloogg__fold');
      this.currentFold.classList.add('open');
      var foldName = document.createElement('span');
      foldName.textContent = name;
      foldName.classList.add('lloogg__foldName');
      this.currentFold.appendChild(foldName);
      this.currentFold.addEventListener('click', function (event) {
    ...
    value: function pushLine(line) {
      ...
      var parentElement = this.currentFold || this.container;
      var logLine = new _table_row_line_view.TableRowView(parentElement, this.highlightedLines);
      line.render(logLine);

      if (this.currentFold && this.highlightedLines && !this.currentFold.classList.contains('open') && this.counter >= this.highlightedLines.rangeStart && this.counter <= this.highlightedLines.rangeEnd) {
        this.currentFold.classList.add('open');
      }
    }
  }]);
...
},{"./table_row_line_view":10}],9:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Lom = exports.defaultHandlers = undefined;
...
var _text = require('./handlers/text');

var _fold = require('./handlers/fold');

var _display = require('./handlers/display');

var _cursor = require('./handlers/cursor');

var _eof = require('./handlers/eof');

var _log_line = require('./log_line');
...
var defaultHandlers = exports.defaultHandlers = [_fold.foldHandler, _text.textHandler, _cursor.cursorHandler, _display.displayHandler, _eof.eofHandler];

var Lom = exports.Lom = function () {
  function Lom(d, handlers) {
    _classCallCheck(this, Lom);

    // need more D
    this.theD = d;
    // array of frozen lines
    // when we get a newline, we render the line as a <li> for
    // the last time and save the dom node in here
    this.lines = [];
    this.cursor = 0;
    this.tabWidth = 8;
    this.numberOfLines = 0;
    this.container = this.theD.createElement('div');
    this.logView = new _log_view.LogView(this.container);

    // the Brush the current line starts with (needed for rendering)
    this.startBrush = new _brush.Brush();
    // the current Brush at the cursor position
    this.currentBrush = new _brush.Brush();
    // the last line as an array of {char, Brush} tuples
    this.currentLine = [];

    // the list of event handler functions
    this.handlers = handlers;
  }

  _createClass(Lom, [{
    key: 'distanceToNextTabStop',
    value: function distanceToNextTabStop() {
      var dist = this.tabWidth - this.cursor % this.tabWidth;
      return dist == 0 ? this.tabWidth : dist;
    }
  }, {
    key: 'insertChar',
    value: function insertChar(ch) {
      var p = { ch: ch, brush: this.currentBrush.clone() };
      this.currentLine.splice(this.cursor, 1, p);
      this.cursor++;
    }
  }, {
    key: 'pushEvent',
    value: function pushEvent(lomEvent) {
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;
    ...
    value: function render(target) {
      // make a new container to be used as future container,
      // otherwise the linewise updates would push directly to the rendered DOM
      var newContainer = this.theD.createElement('div');
      target.appendChild(this.container);
      this.container = newContainer;
    }

    // get the current line as a table row

  }, {
    key: 'renderCurrentLine',
    value: function renderCurrentLine() {
      var lastBrush = this.startBrush,
          chars = '',
          spans = [],
      ...
      try {
        for (var _iterator2 = this.currentLine[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          var point = _step2.value;

          if (!point.brush.equals(lastBrush)) {
            if (chars.length > 0) {
              spans.push(this.getSpan(lastBrush, chars));
              chars = '';
            }
            lastBrush = point.brush;
          }
          chars += point.ch;
        }
        // add the remainder
      ...
      return new _log_line.LogLine(this.currentLineNumber(), line.innerHTML);
    }
  }, {
    key: 'currentLineNumber',
    value: function currentLineNumber() {
      return this.numberOfLines;
    }
  }, {
    key: 'getSpan',
    value: function getSpan(brush, chars) {
      var span = this.theD.createElement('span');
    ...
    value: function pushLine() {
      this.numberOfLines++;
      this.logView.pushLine(this.renderCurrentLine());
    }
  }, {
    key: 'openFold',
    value: function openFold(name) {
      this.logView.beginFold(name);
    }
  }, {
    key: 'closeFold',
    value: function closeFold() {
      this.logView.endFold();
    }
  }]);
...
},{"../lib/utils":11,"./brush":1,"./handlers/cursor":2,"./handlers/display":3,"./handlers/eof":4,"./handlers/fold":5,"./handlers/text":6,"./log_line":7,"./log_view":8,"./table_row_line_view":10,"babel-polyfill":12}],10:[function(require,module,exports){
'use strict';
...
var highlightedClassName = 'lom__row--highlighted';

var TableRowView = exports.TableRowView = function () {
  function TableRowView(table, highlightedLines) {
    var _this = this;

    _classCallCheck(this, TableRowView);

    this.table = table;
    this.highlightedLines = highlightedLines;
    this.withinHighlightedRange = false;

    this.row = document.createElement('p');

    this.lineNumber = document.createElement('a');
    this.lineContent = document.createElement('span');

    this.lineNumber.addEventListener('click', function (event) {
      var lineNumber = parseInt(_this.row.getAttribute('id').replace(/^L/, ''));
      lineNumber = lineNumber;
      var newHash = '#L' + lineNumber;
      var match = window.location.hash.match(/#L(\d+)(?:\-L(\d+))?$/);

      Array.prototype.forEach.call(document.querySelectorAll('.' + highlightedClassName), function (el) {
        el.classList.remove(highlightedClassName);
      });
      Array.prototype.forEach.call(_this.table.querySelectorAll('.' + highlightedClassName), function (el) {
        el.classList.remove(highlightedClassName);
      });
      event.target.parentElement.classList.add(highlightedClassName);
      if (event.shiftKey && match) {
        var rangeStart = lineNumber;
        var rangeEnd = parseInt(match[1]);
        if (match[2]) {
          rangeEnd = parseInt(match[2]);
        }
        if (lineNumber > parseInt(match[1])) {
          rangeStart = parseInt(match[1]);
          rangeEnd = lineNumber;
        }
        _this._highlightRows(rangeStart, rangeEnd);

        newHash = '#L' + rangeStart + '-L' + rangeEnd;
      }
      if (match) {
        history.pushState(null, null, location.hash.replace(match[0], newHash));
      } else {
        history.pushState(null, null, location.hash + newHash);
      }
    });

    this.row.appendChild(this.lineNumber);
    this.row.appendChild(this.lineContent);
  }

  _createClass(TableRowView, [{
    key: '_highlightRows',
    value: function _highlightRows(rangeStart, rangeEnd) {
      var nthChilds = [];
      for (var i = rangeStart; i <= rangeEnd; i++) {
        nthChilds.push('#L' + i);
      }
      var selector = nthChilds.join(',');
      ...
      Array.prototype.forEach.call(this.table.querySelectorAll(selector), function (element, index) {
        element.classList.add(highlightedClassName);
      });
    }
  }, {
    ...
    key: 'showFoldOpenIndicator',
    value: function showFoldOpenIndicator() {}
  }, {
    key: 'showFoldClosedIndicator',
    value: function showFoldClosedIndicator() {}
  }, {
    key: 'showLineContent',
    value: function showLineContent(content) {
      this.lineContent.outerHTML = content;
    }
  }, {
    key: 'showLineNumber',
    value: function showLineNumber(number) {
      this.row.setAttribute('id', 'L' + number);
      if (this.highlightedLines && number >= this.highlightedLines.rangeStart && number <= this.highlightedLines.rangeEnd) {
        this.row.classList.add(highlightedClassName);
      }
    }
  }, {
    key: 'flush',
...
},{"babel-regenerator-runtime":307,"core-js/fn/regexp/escape":13,"core-js/shim":306}],13:[function(require,module,exports){
require('../../modules/core.regexp.escape');
module.exports = require('../../modules/_core').RegExp.escape;
},{"../../modules/_core":34,"../../modules/core.regexp.escape":131}],14:[function(require,module,exports){
...
},{"./_an-instance":17,"./_ctx":36,"./_defined":38,"./_descriptors":39,"./_for-of":48,"./_hide":51,"./_iter-define":64,"./_iter-step":66,"./_meta":73,"./_object-create":77,"./_object-dp":78,"./_redefine-all":97,"./_set-species":102}],31:[function(require,module,exports){
...
},{"./_export":43,"./_shared":105,"./es6.map":161,"./es6.weak-map":267}],75:[function(require,module,exports){
var global    = require('./_global')
...
},{"./_an-instance":17,"./_array-copy-within":19,"./_array-fill":20,"./_array-includes":22,"./_array-methods":23,"./_classof":28,"./_ctx":36,"./_descriptors":39,"./_export":43,"./_fails":45,"./_global":49,"./_has":50,"./_hide":51,"./_is-array-iter":57,"./_is-integer":59,"./_is-object":60,"./_iter-detect":65,"./_iterators":67,"./_library":69,"./_object-create":77,"./_object-dp":78,"./_object-gopd":81,"./_object-gopn":83,"./_object-gpo":85,"./_property-desc":96,"./_redefine-all":97,"./_same-value":100,"./_set-species":102,"./_species-constructor":106,"./_to-index":116,"./_to-integer":117,"./_to-length":119,"./_to-object":120,"./_to-primitive":121,"./_typed":124,"./_typed-buffer":123,"./_uid":125,"./_wks":128,"./core.get-iterator-method":129,"./core.is-iterable":130,"./es6.array.iterator":142}],123:[function(require,module,exports){
'use strict';
var global         = require('./_global')
  , DESCRIPTORS    = require('./_descriptors')
...
},{"./_classof":28,"./_core":34,"./_iterators":67,"./_wks":128}],131:[function(require,module,exports){
...
},{"./_export":43,"./_replacer":99}],132:[function(require,module,exports){
// 22.1.3.3 Array.prototype.copyWithin(target, start, end = this.length)
var $export = require('./_export');
...
},{"./_add-to-unscopables":16,"./_array-copy-within":19,"./_export":43}],133:[function(require,module,exports){
'use strict';
var $export = require('./_export')
...
},{"./_array-methods":23,"./_export":43,"./_strict-method":107}],134:[function(require,module,exports){
// 22.1.3.6 Array.prototype.fill(value, start = 0, end = this.length)
var $export = require('./_export');
...
},{"./_add-to-unscopables":16,"./_array-fill":20,"./_export":43}],135:[function(require,module,exports){
'use strict';
var $export = require('./_export')
...
},{"./_array-methods":23,"./_export":43,"./_strict-method":107}],136:[function(require,module,exports){
'use strict';
...
require('./_add-to-unscopables')(KEY);
},{"./_add-to-unscopables":16,"./_array-methods":23,"./_export":43}],138:[function(require,module,exports){
'use strict';
var $export  = require('./_export')
...
},{"./_array-methods":23,"./_export":43,"./_strict-method":107}],139:[function(require,module,exports){
'use strict';
var ctx            = require('./_ctx')
  , $export        = require('./_export')
  , toObject       = require('./_to-object')
...
},{"./_create-property":35,"./_ctx":36,"./_export":43,"./_is-array-iter":57,"./_iter-call":62,"./_iter-detect":65,"./_to-length":119,"./_to-object":120,"./core.get-iterator-method":129}],140:[function(require,module,exports){
'use strict';
var $export       = require('./_export')
...
},{"./_array-includes":22,"./_export":43,"./_strict-method":107}],141:[function(require,module,exports){
// 22.1.2.2 / 15.4.3.2 Array.isArray(arg)
var $export = require('./_export');

$export($export.S, 'Array', {isArray: require('./_is-array')});
},{"./_export":43,"./_is-array":58}],142:[function(require,module,exports){
'use strict';
...
},{"./_add-to-unscopables":16,"./_iter-define":64,"./_iter-step":66,"./_iterators":67,"./_to-iobject":118}],143:[function(require,module,exports){
'use strict';
...
},{"./_export":43,"./_iobject":56,"./_strict-method":107,"./_to-iobject":118}],144:[function(require,module,exports){
'use strict';
var $export       = require('./_export')
  , toIObject     = require('./_to-iobject')
  , toInteger     = require('./_to-integer')
...
},{"./_export":43,"./_strict-method":107,"./_to-integer":117,"./_to-iobject":118,"./_to-length":119}],145:[function(require,module,exports){
'use strict';
var $export = require('./_export')
...
},{"./_array-methods":23,"./_export":43,"./_strict-method":107}],146:[function(require,module,exports){
'use strict';
var $export        = require('./_export')
  , createProperty = require('./_create-property');
...
},{"./_create-property":35,"./_export":43,"./_fails":45}],147:[function(require,module,exports){
'use strict';
var $export = require('./_export')
...
},{"./_array-reduce":24,"./_export":43,"./_strict-method":107}],149:[function(require,module,exports){
'use strict';
var $export    = require('./_export')
  , html       = require('./_html')
  , cof        = require('./_cof')
...
},{"./_cof":29,"./_export":43,"./_fails":45,"./_html":52,"./_to-index":116,"./_to-length":119}],150:[function(require,module,exports){
'use strict';
var $export = require('./_export')
...
},{"./_array-methods":23,"./_export":43,"./_strict-method":107}],151:[function(require,module,exports){
'use strict';
var $export   = require('./_export')
  , aFunction = require('./_a-function')
  , toObject  = require('./_to-object')
...
},{"./_a-function":14,"./_export":43,"./_fails":45,"./_strict-method":107,"./_to-object":120}],152:[function(require,module,exports){
require('./_set-species')('Array');
},{"./_set-species":102}],153:[function(require,module,exports){
// 20.3.3.1 / 15.9.4.4 Date.now()
var $export = require('./_export');

$export($export.S, 'Date', {now: function(){ return new Date().getTime(); }});
},{"./_export":43}],154:[function(require,module,exports){
'use strict';
...
},{"./_export":43,"./_fails":45}],155:[function(require,module,exports){
'use strict';
var $export     = require('./_export')
  , toObject    = require('./_to-object')
  , toPrimitive = require('./_to-primitive');
...
},{"./_export":43,"./_fails":45,"./_to-object":120,"./_to-primitive":121}],156:[function(require,module,exports){
var TO_PRIMITIVE = require('./_wks')('toPrimitive')
  , proto        = Date.prototype;

if(!(TO_PRIMITIVE in proto))require('./_hide')(proto, TO_PRIMITIVE, require('./_date-to-primitive'));
},{"./_date-to-primitive":37,"./_hide":51,"./_wks":128}],157:[function(require,module,exports){
...
},{"./_bind":27,"./_export":43}],159:[function(require,module,exports){
'use strict';
var isObject       = require('./_is-object')
  , getPrototypeOf = require('./_object-gpo')
...
},{"./_is-object":60,"./_object-dp":78,"./_object-gpo":85,"./_wks":128}],160:[function(require,module,exports){
var dP         = require('./_object-dp').f
  , createDesc = require('./_property-desc')
  , has        = require('./_has')
...
},{"./_descriptors":39,"./_has":50,"./_object-dp":78,"./_property-desc":96}],161:[function(require,module,exports){
'use strict';
...
},{"./_collection":33,"./_collection-strong":30}],162:[function(require,module,exports){
...
},{"./_export":43,"./_math-log1p":71}],163:[function(require,module,exports){
...
},{"./_export":43,"./_math-sign":72}],170:[function(require,module,exports){
...
},{"./_export":43,"./_fails":45}],172:[function(require,module,exports){
...
},{"./_export":43,"./_math-log1p":71}],174:[function(require,module,exports){
...
},{"./_export":43,"./_math-sign":72}],176:[function(require,module,exports){
...
},{"./_export":43,"./_fails":45,"./_math-expm1":70}],177:[function(require,module,exports){
...
},{"./_export":43,"./_math-expm1":70}],178:[function(require,module,exports){
...
},{"./_cof":29,"./_descriptors":39,"./_fails":45,"./_global":49,"./_has":50,"./_inherit-if-required":54,"./_object-create":77,"./_object-dp":78,"./_object-gopd":81,"./_object-gopn":83,"./_redefine":98,"./_string-trim":113,"./_to-primitive":121}],180:[function(require,module,exports){
...
},{"./_export":43,"./_global":49}],182:[function(require,module,exports){
// 20.1.2.3 Number.isInteger(number)
var $export = require('./_export');
...
},{"./_export":43,"./_is-integer":59}],185:[function(require,module,exports){
...
},{"./_export":43,"./_parse-float":92}],188:[function(require,module,exports){
var $export   = require('./_export')
  , $parseInt = require('./_parse-int');
// 20.1.2.13 Number.parseInt(string, radix)
$export($export.S + $export.F * (Number.parseInt != $parseInt), 'Number', {parseInt: $parseInt});
},{"./_export":43,"./_parse-int":93}],189:[function(require,module,exports){
'use strict';
var $export      = require('./_export')
  , anInstance   = require('./_an-instance')
  , toInteger    = require('./_to-integer')
...
},{"./_a-number-value":15,"./_an-instance":17,"./_export":43,"./_fails":45,"./_string-repeat":112,"./_to-integer":117}],190:[function(require,module,exports){
'use strict';
var $export      = require('./_export')
  , $fails       = require('./_fails')
  , aNumberValue = require('./_a-number-value')
...
},{"./_a-number-value":15,"./_export":43,"./_fails":45}],191:[function(require,module,exports){
// 19.1.3.1 Object.assign(target, source)
var $export = require('./_export');

$export($export.S + $export.F, 'Object', {assign: require('./_object-assign')});
},{"./_export":43,"./_object-assign":76}],192:[function(require,module,exports){
var $export = require('./_export')
// 19.1.2.2 / 15.2.3.5 Object.create(O [, Properties])
$export($export.S, 'Object', {create: require('./_object-create')});
},{"./_export":43,"./_object-create":77}],193:[function(require,module,exports){
var $export = require('./_export');
// 19.1.2.3 / 15.2.3.7 Object.defineProperties(O, Properties)
$export($export.S + $export.F * !require('./_descriptors'), 'Object', {defineProperties: require('./_object-dps')});
},{"./_descriptors":39,"./_export":43,"./_object-dps":79}],194:[function(require,module,exports){
var $export = require('./_export');
// 19.1.2.4 / 15.2.3.6 Object.defineProperty(O, P, Attributes)
$export($export.S + $export.F * !require('./_descriptors'), 'Object', {defineProperty: require('./_object-dp').f});
},{"./_descriptors":39,"./_export":43,"./_object-dp":78}],195:[function(require,module,exports){
...
},{"./_is-object":60,"./_meta":73,"./_object-sap":89}],196:[function(require,module,exports){
...
},{"./_is-object":60,"./_object-sap":89}],202:[function(require,module,exports){
// 19.1.3.10 Object.is(value1, value2)
var $export = require('./_export');
$export($export.S, 'Object', {is: require('./_same-value')});
},{"./_export":43,"./_same-value":100}],203:[function(require,module,exports){
...
},{"./_is-object":60,"./_meta":73,"./_object-sap":89}],206:[function(require,module,exports){
// 19.1.3.19 Object.setPrototypeOf(O, proto)
var $export = require('./_export');
$export($export.S, 'Object', {setPrototypeOf: require('./_set-proto').set});
},{"./_export":43,"./_set-proto":101}],207:[function(require,module,exports){
'use strict';
...
},{"./_classof":28,"./_redefine":98,"./_wks":128}],208:[function(require,module,exports){
var $export     = require('./_export')
  , $parseFloat = require('./_parse-float');
// 18.2.4 parseFloat(string)
$export($export.G + $export.F * (parseFloat != $parseFloat), {parseFloat: $parseFloat});
},{"./_export":43,"./_parse-float":92}],209:[function(require,module,exports){
var $export   = require('./_export')
  , $parseInt = require('./_parse-int');
// 18.2.5 parseInt(string, radix)
$export($export.G + $export.F * (parseInt != $parseInt), {parseInt: $parseInt});
},{"./_export":43,"./_parse-int":93}],210:[function(require,module,exports){
'use strict';
var LIBRARY            = require('./_library')
  , global             = require('./_global')
  , ctx                = require('./_ctx')
...
},{"./_a-function":14,"./_an-instance":17,"./_an-object":18,"./_classof":28,"./_core":34,"./_ctx":36,"./_export":43,"./_for-of":48,"./_global":49,"./_is-object":60,"./_iter-detect":65,"./_library":69,"./_microtask":75,"./_redefine-all":97,"./_set-proto":101,"./_set-species":102,"./_set-to-string-tag":103,"./_species-constructor":106,"./_task":115,"./_wks":128}],211:[function(require,module,exports){
...
},{"./_export":43}],212:[function(require,module,exports){
...
},{"./_a-function":14,"./_an-object":18,"./_bind":27,"./_export":43,"./_fails":45,"./_is-object":60,"./_object-create":77}],213:[function(require,module,exports){
...
},{"./_an-object":18,"./_export":43,"./_fails":45,"./_object-dp":78,"./_to-primitive":121}],214:[function(require,module,exports){
...
},{"./_an-object":18,"./_export":43,"./_object-gopd":81}],215:[function(require,module,exports){
'use strict';
...
},{"./_an-object":18,"./_export":43,"./_iter-create":63}],216:[function(require,module,exports){
...
},{"./_an-object":18,"./_export":43,"./_object-gopd":81}],217:[function(require,module,exports){
...
},{"./_an-object":18,"./_export":43,"./_object-gpo":85}],218:[function(require,module,exports){
...
},{"./_an-object":18,"./_export":43,"./_has":50,"./_is-object":60,"./_object-gopd":81,"./_object-gpo":85}],219:[function(require,module,exports){
...
},{"./_export":43}],220:[function(require,module,exports){
...
},{"./_an-object":18,"./_export":43}],221:[function(require,module,exports){
// 26.1.11 Reflect.ownKeys(target)
var $export = require('./_export');

$export($export.S, 'Reflect', {ownKeys: require('./_own-keys')});
},{"./_export":43,"./_own-keys":91}],222:[function(require,module,exports){
...
},{"./_an-object":18,"./_export":43}],223:[function(require,module,exports){
...
},{"./_export":43,"./_set-proto":101}],224:[function(require,module,exports){
...
},{"./_an-object":18,"./_export":43,"./_has":50,"./_is-object":60,"./_object-dp":78,"./_object-gopd":81,"./_object-gpo":85,"./_property-desc":96}],225:[function(require,module,exports){
var global            = require('./_global')
  , inheritIfRequired = require('./_inherit-if-required')
  , dP                = require('./_object-dp').f
  , gOPN              = require('./_object-gopn').f
...
},{"./_descriptors":39,"./_fails":45,"./_flags":47,"./_global":49,"./_inherit-if-required":54,"./_is-regexp":61,"./_object-dp":78,"./_object-gopn":83,"./_redefine":98,"./_set-species":102,"./_wks":128}],226:[function(require,module,exports){
// 21.2.5.3 get RegExp.prototype.flags()
if(require('./_descriptors') && /./g.flags != 'g')require('./_object-dp').f(RegExp.prototype, 'flags', {
  configurable: true,
  get: require('./_flags')
});
},{"./_descriptors":39,"./_flags":47,"./_object-dp":78}],227:[function(require,module,exports){
// @@match logic
...
},{"./_fix-re-wks":46}],230:[function(require,module,exports){
// @@split logic
...
},{"./_fix-re-wks":46,"./_is-regexp":61}],231:[function(require,module,exports){
'use strict';
...
},{"./_an-object":18,"./_descriptors":39,"./_fails":45,"./_flags":47,"./_redefine":98,"./es6.regexp.flags":226}],232:[function(require,module,exports){
'use strict';
var strong = require('./_collection-strong');
...
},{"./_collection":33,"./_collection-strong":30}],233:[function(require,module,exports){
'use strict';
...
},{"./_export":43,"./_string-at":108}],238:[function(require,module,exports){
...
},{"./_export":43,"./_fails-is-regexp":44,"./_string-context":109,"./_to-length":119}],239:[function(require,module,exports){
'use strict';
...
},{"./_export":43,"./_to-index":116}],243:[function(require,module,exports){
...
},{"./_export":43,"./_fails-is-regexp":44,"./_string-context":109}],244:[function(require,module,exports){
'use strict';
...
},{"./_iter-define":64,"./_string-at":108}],246:[function(require,module,exports){
'use strict';
...
},{"./_export":43,"./_to-iobject":118,"./_to-length":119}],248:[function(require,module,exports){
var $export = require('./_export');
...
},{"./_export":43,"./_string-repeat":112}],249:[function(require,module,exports){
'use strict';
...
},{"./_export":43,"./_fails-is-regexp":44,"./_string-context":109,"./_to-length":119}],251:[function(require,module,exports){
'use strict';
...
},{"./_string-trim":113}],255:[function(require,module,exports){
'use strict';
...
},{"./_an-object":18,"./_export":43,"./_fails":45,"./_global":49,"./_is-object":60,"./_set-species":102,"./_species-constructor":106,"./_to-index":116,"./_to-length":119,"./_typed":124,"./_typed-buffer":123,"./_wks":128}],257:[function(require,module,exports){
var $export = require('./_export');
$export($export.G + $export.W + $export.F * !require('./_typed').ABV, {
  DataView: require('./_typed-buffer').DataView
});
},{"./_export":43,"./_typed":124,"./_typed-buffer":123}],258:[function(require,module,exports){
...
},{"./_array-methods":23,"./_collection":33,"./_collection-weak":32,"./_has":50,"./_is-object":60,"./_meta":73,"./_object-assign":76,"./_redefine":98}],268:[function(require,module,exports){
'use strict';
...
},{"./_collection":33,"./_collection-weak":32}],269:[function(require,module,exports){
'use strict';
...
},{"./_add-to-unscopables":16,"./_array-includes":22,"./_export":43}],270:[function(require,module,exports){
...
},{"./_cof":29,"./_export":43,"./_global":49,"./_microtask":75}],271:[function(require,module,exports){
...
},{"./_cof":29,"./_export":43}],272:[function(require,module,exports){
// https://github.com/DavidBruant/Map-Set.prototype.toJSON
var $export  = require('./_export');

$export($export.P + $export.R, 'Map', {toJSON: require('./_collection-to-json')('Map')});
},{"./_collection-to-json":31,"./_export":43}],273:[function(require,module,exports){
...
},{"./_export":43}],277:[function(require,module,exports){
'use strict';
var $export         = require('./_export')
  , toObject        = require('./_to-object')
  , aFunction       = require('./_a-function')
...
},{"./_a-function":14,"./_descriptors":39,"./_export":43,"./_object-dp":78,"./_object-forced-pam":80,"./_to-object":120}],279:[function(require,module,exports){
...
},{"./_export":43,"./_object-to-array":90}],280:[function(require,module,exports){
...
},{"./_create-property":35,"./_export":43,"./_object-gopd":81,"./_own-keys":91,"./_to-iobject":118}],281:[function(require,module,exports){
'use strict';
var $export                  = require('./_export')
  , toObject                 = require('./_to-object')
  , toPrimitive              = require('./_to-primitive')
...
},{"./_descriptors":39,"./_export":43,"./_object-forced-pam":80,"./_object-gopd":81,"./_object-gpo":85,"./_to-object":120,"./_to-primitive":121}],283:[function(require,module,exports){
// https://github.com/tc39/proposal-object-values-entries
var $export = require('./_export')
...
},{"./_export":43,"./_object-to-array":90}],284:[function(require,module,exports){
...
},{"./_an-object":18,"./_array-from-iterable":21,"./_metadata":74,"./_object-gpo":85,"./es6.set":232}],287:[function(require,module,exports){
var metadata               = require('./_metadata')
  , anObject               = require('./_an-object')
  , getPrototypeOf         = require('./_object-gpo')
...
},{"./_global":49,"./_hide":51,"./_iterators":67,"./_redefine":98,"./_wks":128,"./es6.array.iterator":142}],304:[function(require,module,exports){
var $export = require('./_export')
  , $task   = require('./_task');
